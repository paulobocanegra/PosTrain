...
function populateCategories(arr){
    ...
    // function test(){
    //     let products = document.querySelectorAll(".new-item")

    //     products.forEach ( product =>{
    //         product.innerHTML = "Hello World"
...
// let currentItems = document.querySelector(".new-item")

// function populateSubCategories(){
//     if (currentItems){
//         switch (subDrinksCategories){
//             case subDrinksCategories === beerTypes:
//                 for (let i in beerTypes ) {
//                     let subCat = document.createElement("li")
//                     subCat.innerHTML = beerTypes[i]
//                     subCat.className = "new-item-cat"
//                     currentItems.appendChild(subCat)
//                 }
//                 break;
//             case subDrinksCategories === wineTypes:
//                 for (let i = 0; i < beerTypes.length; i++) {
//                     let subCat = document.createElement("li")
//                     subCat.innerHTML = arr[i]
//                     subCat.className = "new-item-cat"
//                     currentItems.appendChild(subCat)
//                 }
//                 break;
//             case subDrinksCategories === softDrinksTypes:
//                 for (let i = 0; i < beerTypes.length; i++) {
//                     let subCat = document.createElement("li")
//                     subCat.innerHTML = arr[i]
//                     subCat.className = "new-item-cat"
...
//                 }
//                 break;
//             case subDrinksCategories === milkshakesTypes:
//                 for (let i = 0; i < beerTypes.length; i++) {
//                     let subCat = document.createElement("li")
//                     subCat.innerHTML = arr[i]
//                     subCat.className = "new-item-cat"
...
//                 }
//                 break;
//             case subDrinksCategories === cocktailsTypes:
//                 for (let i = 0; i < beerTypes.length; i++) {
//                     let subCat = document.createElement("li")
//                     subCat.innerHTML = arr[i]
//                     subCat.className = "new-item-cat"
...
//                 }
//                 break;
//             case subDrinksCategories === coffeeTeaTypes:
//                 for (let i = 0; i < beerTypes.length; i++) {
//                     let subCat = document.createElement("li")
//                     subCat.innerHTML = arr[i]
//                     subCat.className = "new-item-cat"
